...
public class RouteBoxer {
    ...
    private static final String TAG = "RouteBoxer";
    ...
    private int[] getGridCoordsFromHint_(LatLng latlng, LatLng  hintlatlng,int[] hint) {
        ...
        try {
            ...
            Log.w(TAG,"getGridCoordsFromHint_ IndexOutOfBoundsException x"+x+" y "+y);
        }
        int[] result = {x, y};
        return result;
    };
    ...
    private void markCell_(int[] cell) {
        ...
        try {
            ...
            Log.w(TAG, "markCell_ IndexOutOfBoundsException x"+x+" y "+y);
        }
    };
